...
const groupsOfBlood = ["0 (I)", "A (II)", "B (III)", "AB (IV)"];

export default function Content() {
  const { dept, data } = useDonor();
  ...
  return (
    <Layout.Content style={contentStyle}>
      <h2 style={{ color: "#000" }}>
        <a target='blank' href={dept === null ? "" : dept.url}>
          {dept === null ? "" : dept.deptTitle}
        </a>
      </h2>
      <Flex style={boxStyle} justify={"space-around"}>
        <Flex vertical>
          <Flex vertical align="center">
            ...
            <Flex horizontal style={resusStyle}>
              <Flex className={dept === null ? "" : dept.donorTraficlighter[0]}>
                Rh+
              </Flex>
              <Flex
                className={dept === null ? "" : dept.donorTraficlighter[1]}
                style={{ marginLeft: 10 }}
              >
                Rh-
              </Flex>
          ...
          <Flex vertical align="center" style={{ marginTop: 10 }}>
            ...
            <Flex horizontal style={resusStyle}>
              <Flex className={dept === null ? "" : dept.donorTraficlighter[4]}>
                Rh+
              </Flex>
              <Flex
                className={dept === null ? "" : dept.donorTraficlighter[5]}
                style={{ marginLeft: 10 }}
              >
                Rh-
              </Flex>
        ...
        <Flex vertical>
          <Flex vertical align="center">
            ...
            <Flex horizontal style={resusStyle}>
              <Flex className={dept === null ? "" : dept.donorTraficlighter[2]}>
                Rh+
              </Flex>
              <Flex
                className={dept === null ? "" : dept.donorTraficlighter[3]}
                style={{ marginLeft: 10 }}
              >
                Rh-
              </Flex>
          ...
          <Flex vertical align="center" style={{ marginTop: 10 }}>
            ...
            <Flex horizontal style={resusStyle}>
              <Flex className={dept === null ? "" : dept.donorTraficlighter[6]}>
                Rh+
              </Flex>
              <Flex
                className={dept === null ? "" : dept.donorTraficlighter[7]}
                style={{ marginLeft: 10 }}
              >
                Rh-
              </Flex>
